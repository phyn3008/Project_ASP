...
{
    public partial class DatMonChoBan : System.Web.UI.Page
    {
        ...
        protected void btnThem_Click(object sender, EventArgs e)
        {
            ...
            // Thông báo cho người dùng hoặc chuyển hướng đến trang CTDatBan.aspx
            Response.Write("<script> alert('Đã thêm món ăn. Vui Lòng Check Bill.') </script>");
        }
    }
}