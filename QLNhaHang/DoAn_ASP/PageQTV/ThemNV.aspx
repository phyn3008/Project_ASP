...
<asp:Content ID="Content4" ContentPlaceHolderID="cphThemXoa" runat="server">
    <div class="container-fluid">
        ...
        <div class="row py-3">
            ...
            <asp:TextBox CssClass="col" ID="txtsdt" runat="server" Width="250px"></asp:TextBox>
        </div>
        ...
        <div class="row py-3">
            ...
            <asp:TextBox CssClass="col-3" ID="txtDiaChi" runat="server" Width="250px"></asp:TextBox>
        </div>

        <div class="row py-3">
            <asp:Label CssClass="col-3 text-left" runat="server" Text="CMND:"></asp:Label>
            <asp:TextBox CssClass="col-3" ID="txtcmnd" runat="server" Width="250px"></asp:TextBox>
            <asp:Label CssClass="col-3 text-right" runat="server" Text="Email:"></asp:Label>
            <asp:TextBox CssClass="col-3" ID="txtemail" runat="server" Width="250px"></asp:TextBox>
        </div>
