...
<asp:Content ID="Content1" ContentPlaceHolderID="cphXemNhanVien" runat="server">
    ...
    <asp:GridView ID="gvNhanVien" runat="server" Width="100%" DataSourceID="sqldataNhanVien" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="MaNV">
